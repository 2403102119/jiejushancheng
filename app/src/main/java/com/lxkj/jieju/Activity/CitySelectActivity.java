...
import com.lxkj.jieju.View.SideBar;
...
public class CitySelectActivity extends BaseActivity {
    ...
    private TextView dialog,tv_back;
...
//    private CharacterParser characterParser;
    ...
    protected void initView(Bundle savedInstanceState) {
        setContainer(R.layout.activity_city_select);
...
//        mlocationClient.startLocation();//启动定位
            ...
            public void onLocationChanged(AMapLocation aMapLocation) {
                if (aMapLocation != null) {
                    if (aMapLocation.getErrorCode() == 0) {
                        adapter.updateLocateState(SC_CityRecyclerAdapter.SUCCESS, StringUtil_li.cutStr(aMapLocation.getCity(),5),aMapLocation.getLatitude(),aMapLocation.getLongitude());
        ...
        adapter.updateLocateState(SC_CityRecyclerAdapter.SUCCESS, StringUtil_li.cutStr(site,5),lat,lng);
    }
