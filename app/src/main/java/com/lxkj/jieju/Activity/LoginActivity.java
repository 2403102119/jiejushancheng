...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    private TextView tv_regist,tv_forget,tv_login,tv_kuaijie;
...
//            Manifest.permission.WRITE_CALENDAR,//写日历
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        tv_kuaijie = findViewById(R.id.tv_kuaijie);
...
//                userLogin(edit1.getText().toString(), MD5Util.encrypt(edit2.getText().toString()),jupshID,StringUtil_li.getSerialNumber());
                userLogin(edit1.getText().toString(), MD5Util.encrypt(edit2.getText().toString()),jupshID);
                break;
            case R.id.tv_kuaijie://快捷登录
                Intent intent2 = new Intent(mContext,ShortcutActivity.class);
