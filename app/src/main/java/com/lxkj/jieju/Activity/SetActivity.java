...
//                startActivity(intent1);
    ...
    private void aboutUs() {
        ...
        OkHttpHelper.getInstance().post_json(this, NetClass.BASE_URL, params, new BaseCallback<AboutUsbean>() {
            @Override
            ...
            @Override
            public void onSuccess(Response response, final AboutUsbean resultBean) {
