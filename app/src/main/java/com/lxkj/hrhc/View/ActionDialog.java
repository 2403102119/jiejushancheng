...
import com.lxkj.hrhc.Activity.StartActivity;
...
public class ActionDialog extends Dialog {
    ...
    public ActionDialog(final Context context, String title, String text, String left, String right) {
        ...
        ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(context.getResources().getColor(R.color.appColor));
        ForegroundColorSpan foregroundColorSpan1 = new ForegroundColorSpan(context.getResources().getColor(R.color.appColor));
