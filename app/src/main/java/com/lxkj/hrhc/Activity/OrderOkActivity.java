...
import com.lxkj.hrhc.Adapter.OrderOkAdapter;
...
import com.lxkj.hrhc.Bean.ProductBuyBean;
...
import com.lxkj.hrhc.Utils.StatusBarUtil;
...
public class OrderOkActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_payment://付款
                ...
                if (type.equals("0")){
                    productBuy(productid,skuId,count,tv_beizhu.getText().toString(),amount,address_id,yunfei);
                }else {
                    addCartOrder(idlist,tv_beizhu.getText().toString(),zongji,address_id,yunfei);
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 111&&resultCode == 222){
            ...
            tv_phone.setText(data.getStringExtra("telephone"));
            ...
            public void onSuccess(Response response, Addressbean resultBean) {
                for (int i = 0; i <resultBean.getDataList().size() ; i++) {
                    if (resultBean.getDataList().get(i).getIsDefault().equals("1")){
                        ...
                        tv_phone.setText(resultBean.getDataList().get(i).getPhone());
